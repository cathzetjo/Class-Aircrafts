...
namespace Task_3
{
    class Bomber : Plane
    {
        ...
        public Bomber() : base() { Bombs = 0; }                                               // Default Constructor

        public Bomber(string typeGeneral, string nameGeneral, string modelGeneral, int weighGeneral, int capacity, int passengers, int bombs)  // Syntax Constructor 
                            : base(typeGeneral, nameGeneral, modelGeneral, weighGeneral, capacity, passengers)
        {
            Bombs = bombs;
        }
