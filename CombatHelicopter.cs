...
namespace Task_3
{
    class CombatHelicopter : Helicopter
    {
        ...
        public override string Type                                                              // Properties: type = Combat Helicopter
        {
            get
            {
                return this.type;
        ...
        public CombatHelicopter() : base() { Rockets = 0; }                                     // Default Constructor
        public CombatHelicopter(string typeGeneral, string nameGeneral, string modelGeneral, int weighGeneral, int carry, int rockets)  // Syntax Constructor 
                    : base(typeGeneral, nameGeneral, modelGeneral, weighGeneral, carry)
        {
            Rockets = rockets;
        }
